...
class TestPolicyCli:
    ...
    def test_get_policy_no_policy_prints_default(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_set_policy_persists_then_get_returns_it(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_set_policy_rejects_invalid_choice(
        self, tmp_path: Path
    ) -> None:
