...
**Tag**: `v0.7.3` → `10b5fea429eaccdd81194d7d0a1479e86988a88a` (HEAD actual)
...
- `6773796` docs(limitacion-7): tag re-anclado (intermedio)
- `10b5fea` docs(limitacion-7): SHA tag final
**Fecha**: 2026-09-24
